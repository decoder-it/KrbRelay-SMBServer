...
Create a DNS entry for the target server as *<server_name>1UWhRCAAAAAAAAAAAAAAAAAAAAAAAAAAAAwbEAYBAAAA* you want to relay the kerberos AP-REQ and mapped to your listener/relay IP. <br>
