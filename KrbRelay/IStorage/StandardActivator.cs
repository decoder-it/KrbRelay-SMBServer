...
namespace KrbRelay
{
    ...
    public interface IStandardActivator
    {
        ...
        void StandardCreateInstance(in Guid Clsid, IntPtr punkOuter, CLSCTX dwClsCtx, [In] COSERVERINFO pServerInfo, int dwCount, [In, Out][MarshalAs(UnmanagedType.LPArray)] Ole32.MULTI_QI[] pResults);
